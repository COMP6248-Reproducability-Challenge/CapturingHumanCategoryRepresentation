...
GPU=0
CWD=$(pwd)
CAFFE_DIR=/raid/ekerakin/caffe
MAGIC_DIR=raid/ekerakin/magic-init
CLASS_DIR=/raid/ekerakin/voc-classification
...
MODEL=100_encode_params
MODEL_DIR=./imagenet_1000_size128_resize64_u-200_bigan/models
